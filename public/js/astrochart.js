...
(function (astrology) {
  //Scale of symbols
  astrology.SYMBOL_SCALE = 0.9;

  // BG color
  astrology.COLOR_BACKGROUND = "#fff";

  // Color of planet's symbols
  astrology.POINTS_COLOR = "green";
  astrology.POINTS_COLOR_SUB = "orange";
  ...
  astrology.POINTS_STROKE = 1.6;

  // Font color of signs symbols
  astrology.SIGNS_COLOR = "rgb(0,16,85)";

  // Signs strength of lines
  astrology.SIGNS_STROKE = 1;

  // Chart margin
  astrology.MARGIN = 35; //px
  ...
  astrology.CIRCLE_COLOR = "rgb(0,16,85)";

  // Circles strength of lines
  astrology.CIRCLE_STRONG = 1.2;

  // Color of lines in charts
  astrology.LINE_COLOR = "rgb(0,16,85)";

  // radius / INDOOR_CIRCLE_RADIUS_RATIO
  astrology.INDOOR_CIRCLE_RADIUS_RATIO = 1.6;
  ...
  astrology.COLOR_ARIES = "none";
  astrology.COLOR_TAURUS = "none";
  astrology.COLOR_GEMINI = "none";
  astrology.COLOR_CANCER = "none";
  astrology.COLOR_LEO = "none";
  astrology.COLOR_VIRGO = "none";
  astrology.COLOR_LIBRA = "none";
  astrology.COLOR_SCORPIO = "none";
  astrology.COLOR_SAGITTARIUS = "none";
  astrology.COLOR_CAPRICORN = "none";
  astrology.COLOR_AQUARIUS = "none";
  astrology.COLOR_PISCES = "none";
  ...
  // Aspects
  astrology.ASPECTS = {
    conjunction: {degree: 0, orbit: 10, color: "transparent"}, //合相
    square: {degree: 90, orbit: 8, color: "rgb(255,123,172)"}, //四分
    trine: {degree: 120, orbit: 8, color: "rgb(0,255,0)"}, //三分
    opposition: {degree: 180, orbit: 10, color: "rgb(255,123,172)"}, //二分
  };
...
(function (astrology) {
  ...
  function uranus(x, y) {
    ...
    horns.setAttribute("stroke", astrology.POINTS_COLOR_SUB);
    ...
    body.setAttribute("stroke", astrology.POINTS_COLOR_SUB);
    body.setAttribute("stroke-width", astrology.POINTS_STROKE);
    body.setAttribute("fill", "none");
    wrapper.appendChild(body);
  ...
  function neptune(x, y) {
    ...
    node.setAttribute("stroke", astrology.POINTS_COLOR_SUB);
    node.setAttribute("stroke-width", astrology.POINTS_STROKE);
    node.setAttribute("fill", "none");
    wrapper.appendChild(node);
  ...
  function pluto(x, y) {
    ...
    head.setAttribute("stroke", astrology.POINTS_COLOR_SUB);
...
(function (astrology) {
  ...
  astrology.Radix.prototype.drawUniverse = function () {
    ...
    for (
      ...
      segment.setAttribute(
        "stroke",
        astrology.STROKE_ONLY ? astrology.CIRCLE_COLOR : "#000"
      );
      segment.setAttribute("stroke-width", astrology.STROKE_ONLY ? 1 : 0.5);
