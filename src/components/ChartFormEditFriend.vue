<template>
  <div class="container m-auto mt-5 d-flex justify-content-center">
    <div class="row align-items-center justify-content-center w-100">
      ...
      >
        <h1 class="my-5 align-self-center">編輯好友星盤</h1>
...
export default {
  ...
  data() {
    return {
      ...
      remsgg: "",
      form: {
        name: {value: this.$store.state.currentData.currentName, msg: ""},
        gender: {value: "male", msg: ""},
        date: {value: this.$store.state.currentData.currentBirthday, msg: ""},
        time: {value: this.$store.state.currentData.currentBirthTime, msg: ""},
        address: {
          value: this.$store.state.currentData.currentLocation,
          msg: "",
        },
        addresslist: [
          "台北市",
